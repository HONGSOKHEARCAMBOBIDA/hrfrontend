...
class _PayrollCardState extends State<PayrollCard> {
      ...
      builder: (context, constraints) {
        ...
        return Column(
          children: List.generate(rowCount, (rowIndex) {
            ...
            final secondItem =
                secondIndex < items.length ? items[secondIndex] : null;
  ...
  Widget _buildDeductionsSection() {
    return Column(
      children: [
        ...
        _buildAmountRow('លុយត្រូវកាត់សរុប',
        ...
        children: [
          Text(
            ...
            style: GoogleFonts.siemreap(
              ...
              color:
                  isDeduction ? TheColors.errorColor : TheColors.secondaryColor,
            ),
          ),
          Text(
          ...
          Expanded(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle:
                    GoogleFonts.siemreap(fontSize: 10, color: TheColors.black),
                isDense: true,
                contentPadding:
                    const EdgeInsets.only(left: 1, right: 1, bottom: 6),
                ...
                focusedBorder: OutlineInputBorder(
                  ...
                  borderSide:
                      BorderSide(color: TheColors.secondaryColor, width: 1.2),
                ),
        ...
        children: [
          Expanded(
            child: Text(
              '$label ($count ដង)',
              style:
                  GoogleFonts.siemreap(fontSize: 11, color: TheColors.errorColor),
            ),
          ),
          Text(
  ...
  // Helper method to format currency without dollar sign
  String _formatCurrencyWithoutDollar(dynamic amount) {
    if (amount == null) return '0';
    
    // First format using FormatUtils
    String formatted = FormatUtils.formatCurrency(amount);
    
    // Remove dollar sign and any extra spaces
    formatted = formatted.replaceAll('\$', '').trim();
    
    // You might also want to handle cases where the format might have $ at the beginning or end
    return formatted;
  }
}
